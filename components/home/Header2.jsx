...
export default function Header2() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full mx-auto lg:grid lg:grid-cols-[240px_1fr] xl:grid-cols-[260px_1fr] ">
          {/* ================= LEFT COLUMN : LOGO ================= */}
          <div className="flex items-center justify-between px-3 sm:mx-0 bg-green-800 min-h-[80px]">
            <Link
              href="/"
                ...
                <ul className="flex items-center gap-4 xl:gap-8 2xl:gap-10 text-base xl:text-lg 2xl:text-xl font-medium text-white flex-wrap">
                  {menuItems.map((item, idx) => (
                    ...
                    >
                      <Link
                        href={item.link}
                        className="flex items-center gap-1 hover:text-white/60 whitespace-nowrap transition-colors"
                      >
                        {item.label}
                        ...
                        >
                          {categories.map((cat) => (
                            <Link
                              ...
                              className="block text-green-800 px-4 py-3 hover:bg-gray-100"
                            >
                              {cat.name}
                            </Link>
                          ))}
